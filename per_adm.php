...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <form action="reporte_per_adm.php" method="post" style="display: inline;">
        ...
        <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="nombre_completo" name="nombre_completo"
                        value="<?php echo htmlspecialchars($nombre); ?>" oninput="this.value = this.value.toUpperCase()" readonly>
                </div>
