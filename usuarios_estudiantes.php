...
<div class="contenido main-content">
    <h3 class="display-8 fw-semibold text-uppercase text-center fw-bold fst-italic text-end">Estudiantes</h3>
    ...
    <div class="table-responsive">
        <table id="usuariosTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <?php
                $sql = "SELECT * FROM usuario WHERE rol IN ('Estudiante')";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                        <a href='ver_est.php?id_usuario={$row['id_usuario']}' class='btn btn-secondary'>
                            <i class='fa fa-eye'></i>
                        </a>
