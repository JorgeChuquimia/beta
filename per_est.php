...
<body>
    ...
    <form action="reporte_per_est.php" method="post" style="display: inline;">
...
<h5 class="text-center">Perfil del PPFF/Tutor</h5>
 ...
 <div class="row mb-3">
               <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="nom_ppff" name="nom_ppff" value="<?php echo htmlspecialchars($nom_ppff); ?>" oninput="this.value = this.value.toUpperCase()">
                </div> 
<div class="col-md-6">
    ...
    <input type="text" class="form-control" id="cel_ppff" name="cel_ppff" value="<?php echo $cel_ppff; ?>" 
           ...
           maxlength="8" required>
            ...
            <div class="row mb-3">
                <!-- CI de PPFF -->
                <div class="col-md-6">
                    <label for="ci_ppff" class="form-label">CI del PPFF/Tutor:</label>
                    <input type="text" class="form-control" id="ci_ppff" name="ci_ppff" value="<?php echo $ci_ppff; ?>" required>
                </div>

                <!-- Ocupación de PPFF -->
                <div class="col-md-6">
                    <label for="ocupacion_ppff" class="form-label">Ocupación del PPFF/Tutor:</label>
